...
/* package learn-to-haskell-0.1.0.0 */
#ifndef VERSION_learn_to_haskell
#define VERSION_learn_to_haskell "0.1.0.0"
#endif /* VERSION_learn_to_haskell */
#ifndef MIN_VERSION_learn_to_haskell
#define MIN_VERSION_learn_to_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_learn_to_haskell */
...
#define CURRENT_PACKAGE_KEY "learn-to-haskell-0.1.0.0-Bbg8ezIW6ewEg8ME7Y8vWj"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "learn-to-haskell-0.1.0.0-Bbg8ezIW6ewEg8ME7Y8vWj"
